...
<nav class="navbar navbar-default navbar-host">
	...
	<div class="room-code">
		<span class="hidden-xs">Room Code: </span><b><?php echo strtoupper($roomCode); ?></b>
	</div>
	<div class="pull-right">
		<div id="navbar" class="">
			<ul class="nav navbar-nav">
				<li><a type="button" id="roomButton" class="btn btn-default btn-invert nav-button" onclick="toggleSidebar()">Submissions</a></li>
			</ul>
		</div>
	</div>
</nav>