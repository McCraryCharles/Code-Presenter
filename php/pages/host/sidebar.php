<div class="host-sidebar-open" id="host-sidebar">
		...
		<?php
			...
			if (empty($submissions)) {
				...
				foreach ($submissions as $submission) {
					echo '
						<div class="submission-tab" onclick="loadSubmission('.$submission['id'].')" id="host-submission-tab-'.$submission['id'].'">
	...
	<div class="host-sidebar-footer">
		<a type="button" id="roomButtonClear" class="btn btn-default btn-invert nav-button" onclick="confirmClearSubmissions()">Clear</a>
		<a type="button" id="roomButtonScratch" class="btn btn-default btn-invert nav-button" onclick="loadScratchPad()">Open Scratch Pad</a>
